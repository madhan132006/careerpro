...
-- ---------------------------------------------------------------
INSERT IGNORE INTO career_tests (question, category, option_a, option_b, option_c, option_d, weight_a, weight_b, weight_c, weight_d, is_active) VALUES
('I enjoy solving complex logical problems and puzzles.', 'TECHNICAL', 'Strongly Disagree', 'Disagree', 'Agree', 'Strongly Agree', 1, 2, 3, 4, TRUE),
('I like designing and creating visual content.', 'CREATIVE', 'Strongly Disagree', 'Disagree', 'Agree', 'Strongly Agree', 1, 2, 3, 4, TRUE),
('I am comfortable leading a team towards a goal.', 'MANAGEMENT', 'Strongly Disagree', 'Disagree', 'Agree', 'Strongly Agree', 1, 2, 3, 4, TRUE),
('I enjoy reading research papers and doing in-depth analysis.', 'RESEARCH', 'Strongly Disagree', 'Disagree', 'Agree', 'Strongly Agree', 1, 2, 3, 4, TRUE),
('I enjoy negotiating and closing deals.', 'BUSINESS', 'Strongly Disagree', 'Disagree', 'Agree', 'Strongly Agree', 1, 2, 3, 4, TRUE),
('I prefer building applications or writing code.', 'TECHNICAL', 'Strongly Disagree', 'Disagree', 'Agree', 'Strongly Agree', 1, 2, 3, 4, TRUE),
('I enjoy brainstorming creative marketing ideas.', 'CREATIVE', 'Strongly Disagree', 'Disagree', 'Agree', 'Strongly Agree', 1, 2, 3, 4, TRUE),
('I like organizing people and resources to achieve objectives.', 'MANAGEMENT', 'Strongly Disagree', 'Disagree', 'Agree', 'Strongly Agree', 1, 2, 3, 4, TRUE),
('I am fascinated by how things work at a scientific level.', 'RESEARCH', 'Strongly Disagree', 'Disagree', 'Agree', 'Strongly Agree', 1, 2, 3, 4, TRUE),
('I find entrepreneurship and startups exciting.', 'BUSINESS', 'Strongly Disagree', 'Disagree', 'Agree', 'Strongly Agree', 1, 2, 3, 4, TRUE);
...
VALUES ('admin@careerpro.ai', '$2a$10$q6cr9GuK/G3DWkzLzbzwOe0RD9ucdLN7UBe25KDZwQh2Pou/U3SdO', 'Super Admin', '9999999999', TRUE, TRUE, 2);
